...
if (!executable) {
	if (!architecture || !target) throw new Error("Set RECODEX_CODEX_PATH for this platform.");
...
if (!existsSync(executable))
	throw new Error("Codex executable is missing. Run pnpm install or set RECODEX_CODEX_PATH.");

const [command, ...args] = process.argv.slice(2);
const child =
	command === "tauri"
		? spawn(process.execPath, [require.resolve("@tauri-apps/cli/tauri.js"), ...args], {
				stdio: "inherit",
